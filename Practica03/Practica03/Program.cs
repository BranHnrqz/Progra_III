...
namespace Practica03
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Empleado empleado = new Empleado("Mauro", 25, "Masculino");
            ...
            Console.WriteLine("Bienvenido " + cliente.nombre + " que desea tomar?");
            Console.WriteLine("------------------------------------");
            ...
            if (dec == 1)
            {
                if (cliente.edad < 18)
                {
                    Console.WriteLine("No puede pedir bebidas alcoholicas porque es menor de edad");
                }
                else
                    Console.Clear();
                    Console.WriteLine(empleado.nombre + "Empieza a preparar la bebida...");
        ...
        class Cliente : iPersona
        {
            ...
            {
                return this.nombre + "- Muchas gracias, adios";
            }
        ...
        class Empleado : iPersona
        {
            ...
            public string saludar()
            {
                return "Hola! bienvenido a bebidas y mas. Mi nombre es: " + this.nombre + ", me regal su nombre y edad";
            }

            public string preparar(Bebida bebida)
            {
                string resultado = "Vierte " + bebida.ingredientes + " sobre sobre la vatidora y vate por 30 segundos";
                return resultado;
            }

            public string despedirse()
            {
                return this.nombre + "- Vuee¿lva pronto";
            }
        }
    }
}
